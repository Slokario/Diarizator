...
##################
# Audio utils
# Этот блок служит для предварительной обработки аудио, а именно изменение частоты дискретизации на 16000 Гц и приведение к формату mono wav.
# ОН ВСЁ ЕЩЁ НАХОДИТСЯ В СОСТОЯНИИ ПРОЕКТИРОВАНИЯ
##################
def check_wav_16khz_mono(wavfile):
    """
    True, если wav-файл имеет частоту дискретизации 16кГц и моно
    """
    try:
...
def convert_wavfile(wavfile, outfile):
    """
    Конвертирует файл в mono-wav с частотой дискретизации 16кГц
    """
